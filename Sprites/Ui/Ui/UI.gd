...
func _process(delta):
	if delta == delta:
		pass
	$PreCaveWindow.visible = Global.OverCaveEntrance
	...
	$Buttons/Strength/StrengthL.text = "Lvl " + str(Global.StrengthLvl)
	$Buttons/Value/ValueL.text = "Lvl " + str(Global.ValueLvl)
	$Buttons/Speed/SpeedL.text = "Lvl " + str(Global.SpeedLvl)
	$Buttons/HealthRegen/HealthRegenL.text = "Lvl " + str(Global.HealthRegenLvl)
	$Buttons/Resist/ResistL.text = "Lvl " + str(Global.ResistLvl)
...
func _on_speed_mouse_entered():
	if Global.CommonOreCount < Global.CostSP:
		$Buttons/CostBox/Cost.set("theme_override_colors/font_color", Color(1.0,0.0,0.0,1.0))
	else:
		$Buttons/CostBox/Cost.set("theme_override_colors/font_color", Color(0.0,0.0,0.0,1.0))
	$Buttons/CostBox.visible = true
	Global.DisableAttack = true
	Global.HoveredUpgrade = "SP"
	$Buttons/CostBox/Ore.texture = load("res://Sprites/Objekts/Ores/CommonOrs/CommonOreIcon.png")
	$Buttons/CostBox/Cost.text = str(Global.CostSP)
func _on_speed_mouse_exited():
	$Buttons/CostBox.visible = false
...
func _on_health_regen_mouse_entered():
	...
	Global.DisableAttack = true
	Global.HoveredUpgrade = "SP"
	$Buttons/CostBox/Ore.texture = load("res://Sprites/Objekts/Ores/UncommonOrs/UncommonOreIcon.png")
	$Buttons/CostBox/Cost.text = str(Global.CostHR)
...
func _on_strength_mouse_entered():
	...
	$Buttons/CostBox/Ore.texture = load("res://Sprites/Objekts/Ores/RareOrs/RareOreIcon.png")
	$Buttons/CostBox/Cost.text = str(Global.CostST)
...
func _on_resist_mouse_entered():
	...
	Global.DisableAttack = true
	Global.HoveredUpgrade = "SP"
	$Buttons/CostBox/Ore.texture = load("res://Sprites/Objekts/Ores/EpicOrs/EpicOreIcon.png")
	$Buttons/CostBox/Cost.text = str(Global.CostRE)
...
func _on_value_mouse_entered():
	...
	$Buttons/CostBox/Ore.texture = load("res://Sprites/Objekts/Ores/LegendaryOrs/LegendaryOreIcon.png")
	$Buttons/CostBox/Cost.text = str(Global.CostVA)
...
func _Upgrade():
	...
	if Ore >= Cost:
		...
		$Buttons/CostBox/Cost.text = str(Cost)
	else:
